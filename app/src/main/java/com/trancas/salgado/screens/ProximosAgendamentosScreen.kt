...
@Composable
fun ScheduleScreen() {
    var selectedDate by remember { mutableStateOf(LocalDate.of(2025, 2, 26)) }
    ...
    Column(
        ...
        LazyColumn(Modifier.height(500.dp)) {
            item {
                Card(
                    shape = RoundedCornerShape(20.dp), border = BorderStroke(
                        width = 1.2.dp, color = Color.LightGray
                    )
                ) {
                    Column(
                        modifier = Modifier
